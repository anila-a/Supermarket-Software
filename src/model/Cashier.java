...
public class Cashier extends User implements Checker {
	...
	public Cashier(String username, String password, String name, String surname, Date bday, String email,
	...
	public String toString() {
		return "Cashier [name=" + name + ", surname=" + surname + ", bday=" + bday + ", email=" + email + ", phone="
